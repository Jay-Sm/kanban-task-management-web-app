...
.nav-buttons {
  @apply flex flex-row items-center justify-between gap-x-4 mr-8
}
...
.sidebar {
  @apply min-w-[18.75rem] flex flex-col justify-between text-textColor bg-background2 dark:bg-background2-dark border-r border-borderColor dark:border-borderColor-dark;
  /* @apply w-0 min-w-0 relative -left-full */
}
